...
type Keyboard struct {
	...
	Layout  Keyboard_Layout `protobuf:"varint,1,opt,name=layout,proto3,enum=teckschool.pcbook.Keyboard_Layout" json:"layout,omitempty"`
...
var file_keyboard_message_proto_rawDesc = []byte{
	...
	0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11, 0x74, 0x65, 0x63, 0x6b, 0x73, 0x63,
	...
	0x75, 0x74, 0x18, 0x01, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x22, 0x2e, 0x74, 0x65, 0x63, 0x6b, 0x73,
	...
	0x06, 0x41, 0x5a, 0x45, 0x52, 0x54, 0x59, 0x10, 0x03, 0x42, 0x1a, 0x0a, 0x11, 0x63, 0x6f, 0x6d,
	0x2e, 0x75, 0x73, 0x79, 0x6f, 0x75, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x70, 0x62, 0x50, 0x01,
...
var file_keyboard_message_proto_goTypes = []interface{}{
	(Keyboard_Layout)(0), // 0: teckschool.pcbook.Keyboard.Layout
	(*Keyboard)(nil),     // 1: teckschool.pcbook.Keyboard
}
var file_keyboard_message_proto_depIdxs = []int32{
	0, // 0: teckschool.pcbook.Keyboard.layout:type_name -> teckschool.pcbook.Keyboard.Layout
