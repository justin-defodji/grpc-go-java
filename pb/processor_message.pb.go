...
var file_processor_message_proto_rawDesc = []byte{
	...
	0x61, 0x67, 0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11, 0x74, 0x65, 0x63, 0x6b, 0x73,
	...
	0x06, 0x6d, 0x65, 0x6d, 0x6f, 0x72, 0x79, 0x42, 0x1a, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x75,
	0x73, 0x79, 0x6f, 0x75, 0x2e, 0x67, 0x72, 0x70, 0x63, 0x2e, 0x70, 0x62, 0x50, 0x01, 0x5a, 0x03,
...
var file_processor_message_proto_goTypes = []interface{}{
	(*CPU)(nil),    // 0: teckschool.pcbook.CPU
	(*GPU)(nil),    // 1: teckschool.pcbook.GPU
	(*Memory)(nil), // 2: teckschool.pcbook.Memory
}
var file_processor_message_proto_depIdxs = []int32{
	2, // 0: teckschool.pcbook.GPU.memory:type_name -> teckschool.pcbook.Memory
