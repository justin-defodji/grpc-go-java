...
type Storage struct {
	...
	Driver Storage_Driver `protobuf:"varint,1,opt,name=driver,proto3,enum=teckschool.pcbook.Storage_Driver" json:"driver,omitempty"`
...
var file_storage_message_proto_rawDesc = []byte{
	...
	0x65, 0x2e, 0x70, 0x72, 0x6f, 0x74, 0x6f, 0x12, 0x11, 0x74, 0x65, 0x63, 0x6b, 0x73, 0x63, 0x68,
	...
	0x65, 0x63, 0x6b, 0x73, 0x63, 0x68, 0x6f, 0x6f, 0x6c, 0x2e, 0x70, 0x63, 0x62, 0x6f, 0x6f, 0x6b,
	...
	0x79, 0x18, 0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x19, 0x2e, 0x74, 0x65, 0x63, 0x6b, 0x73, 0x63,
	...
	0x44, 0x10, 0x02, 0x42, 0x1a, 0x0a, 0x11, 0x63, 0x6f, 0x6d, 0x2e, 0x75, 0x73, 0x79, 0x6f, 0x75,
...
var file_storage_message_proto_goTypes = []interface{}{
	(Storage_Driver)(0), // 0: teckschool.pcbook.Storage.Driver
	(*Storage)(nil),     // 1: teckschool.pcbook.Storage
	(*Memory)(nil),      // 2: teckschool.pcbook.Memory
}
var file_storage_message_proto_depIdxs = []int32{
	0, // 0: teckschool.pcbook.Storage.driver:type_name -> teckschool.pcbook.Storage.Driver
	2, // 1: teckschool.pcbook.Storage.memory:type_name -> teckschool.pcbook.Memory
