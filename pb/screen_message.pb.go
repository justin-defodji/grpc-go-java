...
type Screen struct {
	...
	Panel      Screen_Panel       `protobuf:"varint,3,opt,name=panel,proto3,enum=teckschool.pcbook.Screen_Panel" json:"panel,omitempty"`
...
var file_screen_message_proto_rawDesc = []byte{
	...
	0x02, 0x20, 0x01, 0x28, 0x0b, 0x32, 0x24, 0x2e, 0x74, 0x65, 0x63, 0x6b, 0x73, 0x63, 0x68, 0x6f,
	...
	0x18, 0x03, 0x20, 0x01, 0x28, 0x0e, 0x32, 0x1f, 0x2e, 0x74, 0x65, 0x63, 0x6b, 0x73, 0x63, 0x68,
...
var file_screen_message_proto_goTypes = []interface{}{
	(Screen_Panel)(0),         // 0: teckschool.pcbook.Screen.Panel
	(*Screen)(nil),            // 1: teckschool.pcbook.Screen
	(*Screen_Resolution)(nil), // 2: teckschool.pcbook.Screen.Resolution
}
var file_screen_message_proto_depIdxs = []int32{
	2, // 0: teckschool.pcbook.Screen.resolution:type_name -> teckschool.pcbook.Screen.Resolution
	0, // 1: teckschool.pcbook.Screen.panel:type_name -> teckschool.pcbook.Screen.Panel
